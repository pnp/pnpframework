...
namespace PnP.Framework.Test.AppModelExtensions
{
    ...
    {
        private readonly string folder = "SitePages";
        private readonly string pageName = "Home.aspx";
        private readonly string publishingPageName = "Happy";
        private readonly string publishingPageTemplate = "BlankWebPartPage";

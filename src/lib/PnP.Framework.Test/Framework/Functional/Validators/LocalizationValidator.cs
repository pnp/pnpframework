...
namespace PnP.Framework.Tests.Framework.Functional.Validators
{
    class LocalizationValidator : ValidatorBase
    {
        ...
        #region SiteFields
        public bool ValidateSiteFields(PnP.Framework.Provisioning.Model.FieldCollection sElements, PnP.Framework.Provisioning.Model.FieldCollection tElements, TokenParser sParser, TokenParser tParser)
        {
        ...
        private List<Localization> LoadFields(PnP.Framework.Provisioning.Model.FieldCollection coll)
        {
            ...
            foreach (PnP.Framework.Provisioning.Model.Field item in coll)
            {
        ...
        public class Localization
        {
            ...
            public PnP.Framework.Provisioning.Model.FieldCollection Fields { get; set; }
        }

...
&lt;/script&gt;</property>
        ...
        public void CanAddWebPartsToForms()
        {
            ...
            var myfile = new PnP.Framework.Provisioning.Model.File()
            {
                Overwrite = false,
                Src = "EditForm.aspx",
        ...
        public void CanProvisionObjectsRequiredField()
        {
            ...
            template.Files.Add(new PnP.Framework.Provisioning.Model.File() { Overwrite = true, Src = fileName, Folder = "Lists/ProjectDocuments" });
        ...
        public void CanCreateEntities()
        {
            using (var ctx = TestCommon.CreateClientContext())
            {
                ...
                Assert.IsInstanceOfType(template.Files, typeof(PnP.Framework.Provisioning.Model.FileCollection));
            }
        }
    }
}

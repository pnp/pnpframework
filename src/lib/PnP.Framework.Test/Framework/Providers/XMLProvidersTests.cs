...
namespace PnP.Framework.Test.Framework.Providers
{
    ...
    public class XMLProvidersTests
    {
        ...
        public void XMLSerializer_Deserialize_ContentTypes_201605()
        {
            ...
            Assert.AreNotEqual(Guid.Empty, ct.DocumentSetTemplate.SharedFields.FirstOrDefault(c => c.Id == new Guid("f6e7bdd5-bdcb-4c72-9f18-2bd8c27003d3")));
            Assert.AreNotEqual(Guid.Empty, ct.DocumentSetTemplate.SharedFields.FirstOrDefault(c => c.Id == new Guid("a8df65ec-0d06-4df1-8edf-55d48b3936dc")));
            Assert.AreNotEqual(Guid.Empty, ct.DocumentSetTemplate.WelcomePageFields.FirstOrDefault(c => c.Id == new Guid("c69d2ffc-0c86-474a-9cc7-dcd7774da531")));
            Assert.AreNotEqual(Guid.Empty, ct.DocumentSetTemplate.WelcomePageFields.FirstOrDefault(c => c.Id == new Guid("b9132b30-2b9e-47d4-b0fc-1ac34a61506f")));
        ...
        public void XMLSerializer_Serialize_ContentTypes_201605()
        {
            ...
            dt.AllowedContentTypes.Add(new ContentTypeReference { ContentTypeId = "0x01005D4F34E4BE7F4B6892AEBE088EDD215E002" });
            dt.SharedFields.Add(new FieldReference { Id = new Guid("f6e7bdd5-bdcb-4c72-9f18-2bd8c27003d3") });
            dt.SharedFields.Add(new FieldReference { Id = new Guid("a8df65ec-0d06-4df1-8edf-55d48b3936dc") });
            dt.WelcomePageFields.Add(new FieldReference { Id = new Guid("c69d2ffc-0c86-474a-9cc7-dcd7774da531") });
            dt.WelcomePageFields.Add(new FieldReference { Id = new Guid("b9132b30-2b9e-47d4-b0fc-1ac34a61506f") });
        ...
        public void XMLSerializer_Serialize_CustomActions_201605()
        {
            ...
            Assert.AreEqual("https://spmanaged.azurewebsites.net/pages/index.aspx?SPHostUrl={0}", ca.Url);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.RegistrationType.None, ca.RegistrationType);
            Assert.IsNotNull(ca.CommandUIExtension);
            Assert.AreEqual("http://sharepoint.com", ca.ImageUrl);
            Assert.AreEqual("101", ca.RegistrationId);
            Assert.AreEqual("alert('boo')", ca.ScriptBlock);
            ...
            Assert.AreEqual(100, ca.Sequence);
            Assert.AreEqual("~site/PnP_Provisioning_JS/PnP_EmbeddedJS.js", ca.ScriptSrc);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.RegistrationType.ContentType, ca.RegistrationType);
            Assert.IsNull(ca.CommandUIExtension);
        ...
        public void XMLSerializer_Deserialize_Files_201605()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Model.FileLevel.Draft, file.Level);
        ...
        public void XMLSerializer_Serialize_Files_201605()
        {
            ...
            newfile.Security.RoleAssignments.Add(new PnP.Framework.Provisioning.Model.RoleAssignment() { Principal = "admin@sharepoint.com", RoleDefinition = "Owner" });
            newfile.Security.RoleAssignments.Add(new PnP.Framework.Provisioning.Model.RoleAssignment() { Principal = "dev@sharepoint.com", RoleDefinition = "Contributor" });
            ...
            Assert.IsNotNull(file);
            Assert.AreEqual("SitePages", file.Folder);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.FileLevel.Published, file.Level);
            Assert.IsTrue(file.Overwrite);
            ...
            Assert.IsNotNull(file);
            Assert.AreEqual("SAMPLE", file.Folder);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.FileLevel.Draft, file.Level);
            Assert.IsFalse(file.Overwrite);
        ...
        public void XMLSerializer_Deserialize_Directories_201605()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Model.FileLevel.Checkout, dir.Level);
        ...
        public void XMLSerializer_Serialize_Directories_201605()
        {
            ...
            var newdir = new PnP.Framework.Provisioning.Model.Directory()
            {
                Folder = "MyFolder",
                Level = PnP.Framework.Provisioning.Model.FileLevel.Published,
                Overwrite = true,
                ...
                Recursive = true,
                Security = new ObjectSecurity(new List<PnP.Framework.Provisioning.Model.RoleAssignment>()
                {
            ...
            newdir = new PnP.Framework.Provisioning.Model.Directory()
            {
                Folder = "MyFolder2",
                Level = PnP.Framework.Provisioning.Model.FileLevel.Checkout,
                Overwrite = false,
                Src = "Documents",
            ...
            Assert.IsNotNull(dir);
            Assert.AreEqual("SiteAssets", dir.Src);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.FileLevel.Published, dir.Level);
            Assert.IsTrue(dir.Overwrite);
            Assert.IsTrue(dir.Recursive);
            Assert.AreEqual(".aspx", dir.ExcludedExtensions);
            Assert.AreEqual(".docx", dir.IncludedExtensions);
            ...
            Assert.IsNotNull(dir);
            Assert.AreEqual("Documents", dir.Src);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.FileLevel.Checkout, dir.Level);
            Assert.IsFalse(dir.Overwrite);
            Assert.IsFalse(dir.Recursive);
            Assert.AreEqual(".xslx", dir.ExcludedExtensions);
            Assert.AreEqual(".txt", dir.IncludedExtensions);
        ...
        public void XMLSerializer_Serialize_Pages_201605()
        {
            ...
            var newpage = new PnP.Framework.Provisioning.Model.Page("home.aspx", true, WikiPageLayout.ThreeColumnsHeaderFooter, new List<WebPart>(), new ObjectSecurity());
            newpage.Security.CopyRoleAssignments = true;
            newpage.Security.ClearSubscopes = true;
            newpage.Security.RoleAssignments.Add(new PnP.Framework.Provisioning.Model.RoleAssignment() { Principal = "admin@sharepoint.com", RoleDefinition = "owner" });
            newpage.Security.RoleAssignments.Add(new PnP.Framework.Provisioning.Model.RoleAssignment() { Principal = "dev@sharepoint.com", RoleDefinition = "contributor" });
            ...
            newpage = new PnP.Framework.Provisioning.Model.Page()
            {
                Url = "help.aspx",
                Overwrite = false,
            };
            ...
            Assert.IsNotNull(page);
            Assert.IsTrue(page.Overwrite);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.WikiPageLayout.ThreeColumnsHeaderFooter, page.Layout);
        ...
        public void XMLSerializer_Serialize_TermGroups_201605()
        {
            ...
            termgroup.Contributors.Add(new PnP.Framework.Provisioning.Model.User() { Name = "contributor1@termgroup1" });
            termgroup.Contributors.Add(new PnP.Framework.Provisioning.Model.User() { Name = "contributor2@termgroup1" });
        ...
        public void XMLSerializer_Serialize_Workflows_201605()
        {
            ...
            Assert.AreEqual("List", wd.RestrictToScope);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.WorkflowsWorkflowDefinitionRestrictToType.List, wd.RestrictToType);
            Assert.AreEqual("workflow1.xaml", wd.XamlPath);
            Assert.IsNotNull(wd.Properties);
            Assert.AreEqual(2, wd.Properties.Count());
            Assert.IsNotNull(wd.Properties.FirstOrDefault(p => p.Key == "MyWorkflowProperty1"));
        ...
        public void XMLSerializer_Serialize_Publishing_201605()
        {
            ...
            var template = wrappedResult.Templates[0].ProvisioningTemplate.First();
            Assert.IsNotNull(template.Publishing);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.PublishingAutoCheckRequirements.SkipIfNotCompliant, template.Publishing.AutoCheckRequirements);
            Assert.IsNotNull(template.Publishing.DesignPackage);
            Assert.AreEqual("mypackage", template.Publishing.DesignPackage.DesignPackagePath);
            Assert.AreEqual(2, template.Publishing.DesignPackage.MajorVersion);
        ...
        public void XMLSerializer_Serialize_AddIns_201605()
        {
            ...
            Assert.AreEqual(2, template.AddIns.Count());
            Assert.IsNotNull(template.AddIns.FirstOrDefault(a => a.PackagePath == "myaddin1.app"));
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.AddInsAddinSource.DeveloperSite, template.AddIns.FirstOrDefault(a => a.PackagePath == "myaddin1.app").Source);
            Assert.IsNotNull(template.AddIns.FirstOrDefault(a => a.PackagePath == "myaddin2.app"));
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.AddInsAddinSource.Marketplace, template.AddIns.FirstOrDefault(a => a.PackagePath == "myaddin2.app").Source);
        }
        ...
        public void XMLSerializer_Deserialize_ExtensibilityHandlers_201605()
        {
            ...
            Assert.AreEqual("System.Private.CoreLib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", handler.Assembly);
        ...
        public void XMLSerializer_Serialize_RegionalSettings_201605()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.CalendarType.GregorianArabicCalendar, template.RegionalSettings.AlternateCalendarType);
            Assert.IsTrue(template.RegionalSettings.AlternateCalendarTypeSpecified);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.CalendarType.Gregorian, template.RegionalSettings.CalendarType);
            Assert.IsTrue(template.RegionalSettings.CalendarTypeSpecified);
            Assert.AreEqual(1, template.RegionalSettings.Collation);
            Assert.IsTrue(template.RegionalSettings.CollationSpecified);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.DayOfWeek.Sunday, template.RegionalSettings.FirstDayOfWeek);
            ...
            Assert.AreEqual("2", template.RegionalSettings.TimeZone);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.WorkHour.Item600PM, template.RegionalSettings.WorkDayEndHour);
            Assert.IsTrue(template.RegionalSettings.WorkDayEndHourSpecified);
            Assert.AreEqual(5, template.RegionalSettings.WorkDays);
            Assert.IsTrue(template.RegionalSettings.WorkDaysSpecified);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.WorkHour.Item900AM, template.RegionalSettings.WorkDayStartHour);
        ...
        public void XMLSerializer_Serialize_Navigation_201605()
        {
            ...
            Assert.IsNotNull(template.Navigation);
            Assert.IsNotNull(template.Navigation.GlobalNavigation);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.NavigationGlobalNavigationNavigationType.Managed, template.Navigation.GlobalNavigation.NavigationType);
            Assert.IsNull(template.Navigation.GlobalNavigation.StructuralNavigation);
            Assert.IsNotNull(template.Navigation.GlobalNavigation.ManagedNavigation);
            Assert.AreEqual("415185a1-ee1c-4ce9-9e38-cea3f854e802", template.Navigation.GlobalNavigation.ManagedNavigation.TermSetId);
            Assert.AreEqual("c1175ad1-c710-4131-a6c9-aa854a5cc4c4", template.Navigation.GlobalNavigation.ManagedNavigation.TermStoreId);
            ...
            Assert.IsNotNull(template.Navigation.CurrentNavigation);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.NavigationCurrentNavigationNavigationType.Structural, template.Navigation.CurrentNavigation.NavigationType);
            Assert.IsNull(template.Navigation.CurrentNavigation.ManagedNavigation);
            Assert.IsNotNull(template.Navigation.CurrentNavigation.StructuralNavigation);
            Assert.IsTrue(template.Navigation.CurrentNavigation.StructuralNavigation.RemoveExistingNodes);
        ...
        public void XMLSerializer_Serialize_Security_201605()
        {
            ...
            result.Security.SiteGroups.Add(new SiteGroup(new List<PnP.Framework.Provisioning.Model.User>()
            {
            ...
            Assert.IsTrue(role.Permissions.Contains(PnP.Framework.Provisioning.Providers.Xml.V201605.RoleDefinitionPermission.ViewListItems));
            Assert.IsTrue(role.Permissions.Contains(PnP.Framework.Provisioning.Providers.Xml.V201605.RoleDefinitionPermission.AddListItems));
            ...
            Assert.IsTrue(role.Permissions.Contains(PnP.Framework.Provisioning.Providers.Xml.V201605.RoleDefinitionPermission.EmptyMask));
        ...
        public void XMLSerializer_Serialize_ListInstances_201605()
        {
            ...
            new ObjectSecurity(new List<PnP.Framework.Provisioning.Model.RoleAssignment>() {
                new PnP.Framework.Provisioning.Model.RoleAssignment()
                {
                    Principal ="Principal01",
                    RoleDefinition ="Read"
            ...
            Assert.AreEqual("Any", ua.Location);
            Assert.AreEqual("0x0101", ua.RegistrationId);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201605.RegistrationType.ContentType, ua.RegistrationType);
            Assert.AreEqual(100, ua.Sequence);
            Assert.AreEqual("scriptblock", ua.ScriptBlock);
            Assert.AreEqual("script.js", ua.ScriptSrc);
            Assert.AreEqual("http://somewhere.com/", ua.Url);

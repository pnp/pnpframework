...
namespace PnP.Framework.Test.Framework.Providers
{
    ...
    public class XMLSerializer201903Tests
    {
        ...
        public void XMLSerializer_Serialize_Apps()
        {
            ...
            Provisioning.Providers.Xml.V201903.Provisioning wrappedResult =
                XMLSerializer.Deserialize<Provisioning.Providers.Xml.V201903.Provisioning>(xml);
        ...
        public void XMLSerializer_Serialize_SiteHeader()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.BackgroundEmphasis.Strong, template.Header.BackgroundEmphasis);
        }
        ...
        public void XMLSerializer_Serialize_AppCatalog()
        {
            ...
            var xml = XDocument.Load(path);
            var wrappedResult = XMLSerializer.Deserialize<Provisioning.Providers.Xml.V201903.Provisioning>(xml);
        ...
        public void XMLSerializer_Serialize_TeamTemplate()
        {
            ...
            var teamTempaltes = wrappedResult.Teams.Items
                .Where(t => t is PnP.Framework.Provisioning.Providers.Xml.V201903.TeamTemplate).Cast<PnP.Framework.Provisioning.Providers.Xml.V201903.TeamTemplate>().ToList();
        ...
        public void XMLSerializer_Serialize_RegionalSettings()
        {
            ...
            Assert.AreEqual(1, regionalSettings.AdjustHijriDays);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.CalendarType.ChineseLunar, regionalSettings.AlternateCalendarType);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.CalendarType.Hebrew, regionalSettings.CalendarType);
            Assert.AreEqual(5, regionalSettings.Collation);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.DayOfWeek.Sunday, regionalSettings.FirstDayOfWeek);
            Assert.AreEqual(1, regionalSettings.FirstWeekOfYear);
            Assert.AreEqual(1040, regionalSettings.LocaleId);
            Assert.AreEqual(true, regionalSettings.ShowWeeks);
            Assert.AreEqual(true, regionalSettings.Time24);
        ...
        public void XMLSerializer_Serialize_Files()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.FileLevel.Published, file.Level);
        ...
        public void XMLSerializer_Serialize_Pages()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.WikiPageLayout.TwoColumns, pages[0].Layout);
            Assert.AreEqual(true, template.Pages[0].Overwrite);
            Assert.AreEqual("{site}/SitePages/DemoWikiPage.aspx", pages[0].Url);
        ...
        public void XMLSerializer_Serialize_ClientSidePages()
        {
            ...
            var page = clientSidePages[0];
            // header
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.ClientSidePageHeaderType.Custom, page.Header.Type);
            Assert.AreEqual("./site%20assets/picture.png", page.Header.ServerRelativeImageUrl);
            Assert.AreEqual(10.56, page.Header.TranslateX);
            Assert.AreEqual(15.12345, page.Header.TranslateY);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.ClientSidePageHeaderLayoutType.FullWidthImage, page.Header.LayoutType);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.ClientSidePageHeaderTextAlignment.Center, page.Header.TextAlignment);
            Assert.AreEqual("Alternate text", page.Header.AlternativeText);
            Assert.AreEqual("John Black, Mike White", page.Header.Authors);
            Assert.AreEqual("Bill Green", page.Header.AuthorByLine);
            Assert.AreEqual(5, page.Header.AuthorByLineId);
            ...
            // sections
            Assert.AreEqual(1, section.Order);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.CanvasSectionType.OneColumn, section.Type);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.BackgroundEmphasis.Soft, section.BackgroundEmphasis);

            Assert.AreEqual("...", section.Controls[0].CustomWebPartName);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201903.CanvasControlWebPartType.Image, section.Controls[0].WebPartType);
            Assert.AreEqual("{}", section.Controls[0].JsonControlData);

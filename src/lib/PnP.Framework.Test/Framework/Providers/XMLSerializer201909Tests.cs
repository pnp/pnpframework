...
using PnP.Framework.Provisioning.Providers.Xml.V201909;
...
namespace PnP.Framework.Test.Framework.Providers
{
    ...
    public class XMLSerializer201909Tests
    {
        ...
        public void XMLSerializer_Serialize_Apps()
        {
            ...
            Provisioning.Providers.Xml.V201909.Provisioning wrappedResult =
                XMLSerializer.Deserialize<Provisioning.Providers.Xml.V201909.Provisioning>(xml);
        ...
        public void XMLSerializer_Serialize_SiteHeader()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.Emphasis.Strong, template.Header.BackgroundEmphasis);
        }
        ...
        public void XMLSerializer_Serialize_AppCatalog()
        {
            ...
            Assert.IsTrue(File.Exists(path)); path = Path.GetFullPath(path);
            var xml = XDocument.Load(path);
            var wrappedResult = XMLSerializer.Deserialize<Provisioning.Providers.Xml.V201909.Provisioning>(xml);
        ...
        public void XMLSerializer_Serialize_TeamTemplate()
        {
            ...
            var teamTempaltes = wrappedResult.Teams.Items
                .Where(t => t is PnP.Framework.Provisioning.Providers.Xml.V201909.TeamTemplate).Cast<PnP.Framework.Provisioning.Providers.Xml.V201909.TeamTemplate>().ToList();
        ...
        public void XMLSerializer_Serialize_RegionalSettings()
        {
            ...
            Assert.AreEqual(1, regionalSettings.AdjustHijriDays);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.CalendarType.ChineseLunar, regionalSettings.AlternateCalendarType);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.CalendarType.Hebrew, regionalSettings.CalendarType);
            Assert.AreEqual(5, regionalSettings.Collation);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.DayOfWeek.Sunday, regionalSettings.FirstDayOfWeek);
            Assert.AreEqual(1, regionalSettings.FirstWeekOfYear);
            Assert.AreEqual(1040, regionalSettings.LocaleId);
            Assert.AreEqual(true, regionalSettings.ShowWeeks);
            Assert.AreEqual(true, regionalSettings.Time24);
            Assert.AreEqual("4", regionalSettings.TimeZone);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.WorkHour.Item500PM, regionalSettings.WorkDayEndHour);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.WorkHour.Item900AM, regionalSettings.WorkDayStartHour);
            Assert.AreEqual(62, regionalSettings.WorkDays);
        }
        ...
        public void XMLSerializer_Serialize_Files()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.FileLevel.Published, file.Level);
        ...
        public void XMLSerializer_Serialize_Pages()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.WikiPageLayout.TwoColumns, pages[0].Layout);
            Assert.AreEqual(true, template.Pages[0].Overwrite);
            Assert.AreEqual("{site}/SitePages/DemoWikiPage.aspx", pages[0].Url);
        ...
        public void XMLSerializer_Serialize_ClientSidePages()
        {
            ...
            var page = clientSidePages[0];
            // header
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.BaseClientSidePageHeaderType.Custom, page.Header.Type);
            Assert.AreEqual("./site%20assets/picture.png", page.Header.ServerRelativeImageUrl);
            Assert.AreEqual(10.56, page.Header.TranslateX);
            Assert.AreEqual(15.12345, page.Header.TranslateY);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.BaseClientSidePageHeaderLayoutType.FullWidthImage, page.Header.LayoutType);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.BaseClientSidePageHeaderTextAlignment.Center, page.Header.TextAlignment);
            Assert.AreEqual("Alternate text", page.Header.AlternativeText);
            Assert.AreEqual("John Black, Mike White", page.Header.Authors);
            Assert.AreEqual("Bill Green", page.Header.AuthorByLine);
            Assert.AreEqual(5, page.Header.AuthorByLineId);
            ...
            // sections
            Assert.AreEqual(1, section.Order);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.CanvasSectionType.OneColumnVerticalSection, section.Type);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.Emphasis.Soft, section.BackgroundEmphasis);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.Emphasis.Strong, section.VerticalSectionEmphasis);

            Assert.AreEqual("...", section.Controls[0].CustomWebPartName);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V201909.CanvasControlWebPartType.Image, section.Controls[0].WebPartType);
            Assert.AreEqual("{}", section.Controls[0].JsonControlData);

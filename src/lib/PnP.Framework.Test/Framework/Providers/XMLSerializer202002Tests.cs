...
namespace PnP.Framework.Test.Framework.Providers
{
    ...
    public class XMLSerializer202002Tests
    {
        ...
        public void XMLSerializer_Serialize_Apps()
        {
            ...
            Provisioning.Providers.Xml.V202002.Provisioning wrappedResult =
                XMLSerializer.Deserialize<Provisioning.Providers.Xml.V202002.Provisioning>(xml);
        ...
        public void XMLSerializer_Serialize_SiteHeader()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.Emphasis.Strong, template.Header.BackgroundEmphasis);
        }
        ...
        public void XMLSerializer_Serialize_AppCatalog()
        {
            ...
            Assert.IsTrue(File.Exists(path)); path = Path.GetFullPath(path);
            var xml = XDocument.Load(path);
            var wrappedResult = XMLSerializer.Deserialize<Provisioning.Providers.Xml.V202002.Provisioning>(xml);
        ...
        public void XMLSerializer_Serialize_TeamTemplate()
        {
            ...
            var teamTempaltes = wrappedResult.Teams.Items
                .Where(t => t is PnP.Framework.Provisioning.Providers.Xml.V202002.TeamTemplate).Cast<PnP.Framework.Provisioning.Providers.Xml.V202002.TeamTemplate>().ToList();
        ...
        public void XMLSerializer_Serialize_Tenant_SharingSettings()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.SharingSettingsSharingCapability.ExternalUserAndGuestSharing, sharingSettings.SharingCapability);
            Assert.AreEqual(30, sharingSettings.RequireAnonymousLinksExpireInDays);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.AnonymousLinkType.View, sharingSettings.FileAnonymousLinkType);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.AnonymousLinkType.Edit, sharingSettings.FolderAnonymousLinkType);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.SharingSettingsDefaultSharingLinkType.AnonymousAccess, sharingSettings.DefaultSharingLinkType);
            Assert.AreEqual(true, sharingSettings.PreventExternalUsersFromResharing);
            Assert.AreEqual(true, sharingSettings.RequireAcceptingAccountMatchInvitedAccount);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.SharingSettingsSharingDomainRestrictionMode.AllowList, sharingSettings.SharingDomainRestrictionMode);
        ...
        public void XMLSerializer_Serialize_WebSettings()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.SearchBoxInNavBar.AllPages, webSettings.SearchBoxInNavBar);
            Assert.AreEqual("https://contoso.sharepoint.com/sites/SearchCenter", webSettings.SearchCenterUrl);
        }
        ...
        public void XMLSerializer_Serialize_SiteSettings()
        {
            ...
            Assert.AreEqual(false, siteSettings.AllowSavePublishDeclarativeWorkflow);
            Assert.AreEqual(true, siteSettings.SocialBarOnSitePagesDisabled);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.SearchBoxInNavBar.ModernOnly, siteSettings.SearchBoxInNavBar);
            Assert.AreEqual("https://contoso.sharepoint.com/sites/SearchCenter", siteSettings.SearchCenterUrl);
        }
        ...
        public void XMLSerializer_Serialize_RegionalSettings()
        {
            ...
            Assert.AreEqual(1, regionalSettings.AdjustHijriDays);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.CalendarType.ChineseLunar, regionalSettings.AlternateCalendarType);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.CalendarType.Hebrew, regionalSettings.CalendarType);
            Assert.AreEqual(5, regionalSettings.Collation);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.DayOfWeek.Sunday, regionalSettings.FirstDayOfWeek);
            Assert.AreEqual(1, regionalSettings.FirstWeekOfYear);
            Assert.AreEqual(1040, regionalSettings.LocaleId);
            Assert.AreEqual(true, regionalSettings.ShowWeeks);
            Assert.AreEqual(true, regionalSettings.Time24);
            Assert.AreEqual("4", regionalSettings.TimeZone);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.WorkHour.Item500PM, regionalSettings.WorkDayEndHour);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.WorkHour.Item900AM, regionalSettings.WorkDayStartHour);
            Assert.AreEqual(62, regionalSettings.WorkDays);
        }
        ...
        public void XMLSerializer_Serialize_ContentTypes()
        {
            ...
            documentSetTemplate.AllowedContentTypes.Add(new ContentTypeReference { ContentTypeId = "0x01005D4F34E4BE7F4B6892AEBE088EDD215E002" });
            documentSetTemplate.SharedFields.Add(new FieldReference { Id = new Guid("f6e7bdd5-bdcb-4c72-9f18-2bd8c27003d3") });
            documentSetTemplate.SharedFields.Add(new FieldReference { Id = new Guid("a8df65ec-0d06-4df1-8edf-55d48b3936dc") });
            documentSetTemplate.WelcomePageFields.Add(new FieldReference { Id = new Guid("c69d2ffc-0c86-474a-9cc7-dcd7774da531") });
            documentSetTemplate.WelcomePageFields.Add(new FieldReference { Id = new Guid("b9132b30-2b9e-47d4-b0fc-1ac34a61506f") });
        ...
        public void XMLSerializer_Serialize_Files()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.FileLevel.Published, file.Level);
        ...
        public void XMLSerializer_Serialize_Pages()
        {
            ...
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.WikiPageLayout.TwoColumns, pages[0].Layout);
            Assert.AreEqual(true, template.Pages[0].Overwrite);
            Assert.AreEqual("{site}/SitePages/DemoWikiPage.aspx", pages[0].Url);
        ...
        public void XMLSerializer_Serialize_ClientSidePages()
        {
            ...
            var page = clientSidePages[0];
            // header
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.BaseClientSidePageHeaderType.Custom, page.Header.Type);
            Assert.AreEqual("./site%20assets/picture.png", page.Header.ServerRelativeImageUrl);
            Assert.AreEqual(10.56, page.Header.TranslateX);
            Assert.AreEqual(15.12345, page.Header.TranslateY);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.BaseClientSidePageHeaderLayoutType.FullWidthImage, page.Header.LayoutType);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.BaseClientSidePageHeaderTextAlignment.Center, page.Header.TextAlignment);
            Assert.AreEqual("Alternate text", page.Header.AlternativeText);
            Assert.AreEqual("John Black, Mike White", page.Header.Authors);
            Assert.AreEqual("Bill Green", page.Header.AuthorByLine);
            Assert.AreEqual(5, page.Header.AuthorByLineId);
            ...
            // sections
            Assert.AreEqual(1, section.Order);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.CanvasSectionType.OneColumnVerticalSection, section.Type);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.Emphasis.Soft, section.BackgroundEmphasis);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.Emphasis.Strong, section.VerticalSectionEmphasis);

            Assert.AreEqual("...", section.Controls[0].CustomWebPartName);
            Assert.AreEqual(PnP.Framework.Provisioning.Providers.Xml.V202002.CanvasControlWebPartType.Image, section.Controls[0].WebPartType);
            Assert.AreEqual("{}", section.Controls[0].JsonControlData);

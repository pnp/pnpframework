    ...
    public class UnifiedGroupsUtilityTests
    {
        ...
        public void Initialize()
        {
            ...
            if (!string.IsNullOrEmpty(_accessToken))
            {
                ...
                _groupId = UnifiedGroupsUtility.CreateUnifiedGroup("PnPDeletedUnifiedGroup test", "PnPDeletedUnifiedGroup test", $"pnp-unit-test-{random.Next(1, 1000)}", _accessToken, groupLogo: null, preferredDataLocation: null).GroupId;

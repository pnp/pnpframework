    ...
    internal static class ListDependencyMigrationReportSection
    {
        ...
        private static void AppendPlan(MarkdownReportWriter writer, ListMaterializationPlan plan)
        {
            ...
            writer.Table(null, new[] { "Property", "Value", "How to read it" }, new[]
            {
                ...
                Row("targetRootFolderServerRelativeUrl", plan.TargetRootFolderServerRelativeUrl, "Exact approved target List/library root path."),
                Row("targetTitle", plan.TargetTitle, "Exact approved target title; may differ only through a sealed override."),
                Row("originalIdentifier", plan.OriginalIdentifier, "Source-qualified provenance written to the target List root folder."),
                Row("disposition", plan.Disposition, "CreateOwned creates; ReuseOwned requires exact provenance and semantic digest; Block prevents mutation."),
            ...
            if (probe != null)
            {
                writer.Table(null, new[] { "Target probe property", "Observed value", "Interpretation" }, new[]
                {
                    ...
                    Row("targetRootFolderServerRelativeUrl", probe.TargetRootFolderServerRelativeUrl, "Exact collision namespace."),

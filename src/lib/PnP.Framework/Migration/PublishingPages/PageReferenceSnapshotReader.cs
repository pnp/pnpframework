...
namespace PnP.Framework.Migration.PublishingPages
{
    internal static class PageReferenceSnapshotReader
    {
        ...
        public static List<PageReferenceSnapshot> Read(
            ...
            IEnumerable<PageWebPartSnapshot> webParts,
            PublishingPageExportOptions options,
            ICollection<string> warnings)
        {
            var candidates = ExtractHtmlReferences(publishingPageContent);
            ...
            var sourcePageUri = new Uri(sourceWebUri.GetLeftPart(UriPartial.Authority) + PublishingPagePath.Encode(source.PageServerRelativeUrl));
            ...
            ICollection<string> warnings)
        {
            ...
            {
                Id = PublishingPageDigest.ComputeSha256($"{candidate.Consumer}\n{absoluteUri.AbsoluteUri}"),
            ...
            try
            {
                ...
                reference.ContentSha256 = PublishingPageDigest.ComputeSha256(payload);
            }

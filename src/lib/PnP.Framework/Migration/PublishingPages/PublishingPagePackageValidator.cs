...
namespace PnP.Framework.Migration.PublishingPages
{
    public static class PublishingPagePackageValidator
    {
        public static void ValidateExport(PublishingPageExportPackage package)
        {
            ...
            {
                throw new InvalidDataException("The source snapshot is missing its profile, identity, policy, security, lifecycle, or source fence.");
            }
        ...
        public static void ValidateMigration(PublishingPageMigrationPackage package)
        {
            ...
            var expectedContent = PublishingPageContentTransformer.Rewrite(
            ...
            var derivedLifecycle = PageLifecyclePolicy.DeriveTargetLifecycle(package.Snapshot.Lifecycle);

...
namespace PnP.Framework.Provisioning.ObjectHandlers.Utilities
{
    internal static class TermGroupHelper
    {
           ...
           TermStore termStore, TokenParser parser, PnPMonitoredScope scope)
        {
            ...
            {
                // This is a really sucky (temporary) way to handle transient Server Exceptions (I found no other solution for now)!
                ...
                return CreateTerm(context, modelTerm, parent, termStore, parser, scope);
            }

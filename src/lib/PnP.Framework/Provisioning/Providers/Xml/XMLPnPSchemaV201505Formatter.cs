...
using PnP.Framework.Provisioning.Providers.Xml.V201505;
...
namespace PnP.Framework.Provisioning.Providers.Xml
{
    ...
    internal class XMLPnPSchemaV201505Formatter : IXMLSchemaFormatter, ITemplateFormatterWithValidation
    {
        ...
        public ValidationResult GetValidationResults(Stream template)
        {
            ...
            Stream stream = typeof(XMLPnPSchemaV201505Formatter)
                .Assembly
                .GetManifestResourceStream("PnP.Framework.Provisioning.Providers.Xml.ProvisioningSchema-2015-05.xsd");
        ...
        Stream ITemplateFormatter.ToFormattedTemplate(Model.ProvisioningTemplate template)
        {
            ...
            {
                Preferences = new V201505.Preferences
                {
                    Generator = this.GetType().Assembly.FullName
                },
                Templates = new V201505.Templates[] {
        ...
        public Model.ProvisioningTemplate ToProvisioningTemplate(Stream template, String identifier)
        {
            ...
            if (!validationResult.IsValid)
            {
                ...
                throw new ApplicationException("The provided template is not valid", new AggregateException(validationResult.Exceptions));
            }

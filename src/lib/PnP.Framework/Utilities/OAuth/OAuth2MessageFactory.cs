namespace SharePointPnP.IdentityModel.Extensions.S2S.Protocols.OAuth2
{
    public static class OAuth2MessageFactory
    {
        ...
        //public static OAuth2AccessTokenRequest CreateAccessTokenRequestWithAssertion(SecurityToken token, List<SecurityTokenHandler> securityTokenHandlers, string resource)
        //{
        //    Utility.VerifyNonNullArgument("token", token);
